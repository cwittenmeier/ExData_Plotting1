...
plot4 <- function(){
        ...
        vecnum=makeNum(filter$Voltage)
        
        vocnum=makeNum(filter$Global_reactive_power)
        
        vucnum=makeNum(filter$Global_active_power)
        ...
        par(mfrow=c(2,2))
        plot(ct,vucnum,xaxt="n",type="l",xlab="",ylab="Global Active Power (kilowatts)")
        axis(1,at=c(thursday,friday,saturday),c("Thu","Fri","Sat"))
        
        plot(ct,vecnum,type="l",ylab="Voltage",xlab="datetime",xaxt="n")
        axis(1,at=c(thursday,friday,saturday),c("Thu","Fri","Sat"))
        ...
        plot(ct,vocnum,type="l",ylab="Global_reactive_power",xlab="datetime",xaxt="n")
        axis(1,at=c(thursday,friday,saturday),c("Thu","Fri","Sat"))
